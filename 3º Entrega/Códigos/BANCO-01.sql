...
CREATE TABLE curriculo (  -- cria tabela que vai conter os dados do curriculo 
  ...
  arquivo_conteudo longblob,  -- colocar o caminho do arquivo ao invez do arq. 
...
insert into adminUser (usuario,senha) values ("usuario","senha2");

-- -- Excluir linha. 
delete from adminUser where usuario = "admin";
...
insert into vagas (nome,descricao,dataEntrada,dataLimite,cpf) values ("analista","vaga abc","2020/12/05","2020/12/05",123456);
select * from vagas;
